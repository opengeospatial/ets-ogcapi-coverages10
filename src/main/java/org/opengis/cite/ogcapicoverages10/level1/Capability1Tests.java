package org.opengis.cite.ogcapicoverages10.level1;
...
import org.opengis.cite.ogcapicoverages10.ErrorMessage;
import org.opengis.cite.ogcapicoverages10.ErrorMessageKeys;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.ogcapicoverages10.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/ogcapicoverages10/rnc/atom.rnc");

...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  <ctl:function name="tns:run-ets-${ets-code}">
    ...
    <ctl:description>Runs the OGC API - Coverages (${version}) test suite.</ctl:description>
    <ctl:code>
    ...
    <ctl:code>
      <xsl:variable name="form-data">
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          ...
          <div style="background:#F0F8FF" bgcolor="#F0F8FF">
            ...
            <ul>
              <li>
                <a href="http://docs.opengeospatial.org/is/17-069r3/17-069r3.html">OGC API - Coverages - Part 1: Core</a>
              </li>
            </ul>
          ...
          <fieldset style="background:#ccffff">
            ...
            <p>
              <label for="ogc-api-coverages-uri">
                <h4 style="margin-bottom: 0.5em">Location of the landing page</h4>
              </label>
              <input id="ogc-api-coverages-uri" name="ogc-api-coverages-uri" size="128" type="text"
                     value="" />
            </p>
            <p>
      ...
      <xsl:variable name="test-run-props">
        <properties version="1.0">
          <entry key="iut">
            <xsl:value-of select="normalize-space($form-data/values/value[@key='ogc-api-coverages-uri'])" />
          </entry>

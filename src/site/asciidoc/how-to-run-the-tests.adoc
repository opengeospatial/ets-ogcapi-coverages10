...
As entry point the Landing Page of the ogcapi-coverages 1.0 is expected.
...
`java -jar ets-ogcapi-coverages10-0.1-SNAPSHOT-aio.jar [-o|--outputDir $TMPDIR] [test-run-props.xml]`
